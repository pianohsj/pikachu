...
router.post('/insert', function(request, response, next){
    ...
    connection.query('insert into member (user_id, user_pw ,user_name, user_email, user_tell, user_address, user_job, user_gender, user_birth ) values (?,?,?,?,?,?,?,?,?);', 
                    [request.body.user_id, request.body.user_passwd, request.body.user_name, request.body.user_email, request.body.user_tell, request.body.user_address, request.body.user_job, request.body.user_gender, request.body.user_birth],
                     function(error){
        if(!error){
